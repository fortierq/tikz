...
\begin{tikzpicture}
    ...
    \node[fill=white] at (.5*\w, 0) {Problèmes de décision};
    \node[] at (.5*\w, .95*\h) {\texttt{ARRET}};
    ...
    \node[] at (.5*\w, .75*\h) {\texttt{REGEXP-EQUIV}};
    ...
    \node[] at (.5*\w, .365*\h) {\texttt{MAX-COUPLAGE-BIPARTI}};
    \node[] at (.5*\w, 4.5) {\texttt{MIN-ARBRE-COUVRANT}};
    \node[] at (.375*\w, .6*\h) {\texttt{SAT}};
    \node[] at (.625*\w, .6*\h) {\texttt{3-SAT}};
    \node[] at (.375*\w, .525*\h) {\texttt{3-COLOR}};
    \node[] at (.625*\w, .525*\h) {\texttt{CLIQUE}};
    \node[] at (.5*\w, 4.5) {\texttt{MIN-ARBRE-COUVRANT}};
\end{tikzpicture}
