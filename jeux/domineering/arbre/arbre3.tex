...
\begin{tikzpicture}
    ...
    \plat{10}{\h}{4}{4}
    \plat{30}{\h}{4}{4}
    \draw[ultra thick, red] (41, 6.5) rectangle (48, 13.5);
    \plat{42.5}{\h}{4}{4}
    ...
    \node[scale=3] at (-2, 2) {\makecell{Joueur 0\\(max)}};
    \node[scale=3] at (-2, 10) {\makecell{Joueur 1\\(min)}};
    \node[scale=3] at (-2, 18) {\makecell{Joueur 0\\(max)}};
    
    \foreach \x/\y/\s in {2/-1/-2, 7/-1/-\infty, 12/-1/-\infty, 17/-1/-1, 22/-1/-1, 27/-1/0, 32/-1/1, 37/-1/0, 42/-1/1, 47/-1/1, 15/10/-\infty, 35/10/0, 47.5/10/1, 27.5/18/1 }
    \draw (\x, \y) node[scale=3] {$\s$};
\end{tikzpicture}
